    ...
    <div className="min-h-screen overflow-hidden bg-[#fbfaf7] text-[#111315]">
      ...
      <header className="sticky top-0 z-40 border-b border-black/6 bg-[#fbfaf7]/90 backdrop-blur-xl">
        <div className="container flex h-18.5 items-center justify-between gap-8">
          ...
          <div className="hidden items-center gap-4 lg:flex"><a href="/login" className="text-[13px] font-bold text-[#596066] transition-colors hover:text-[#111315]">Entrar</a><a href="/cadastro" className="button button-dark">Solicite seu acesso <ArrowRight className="h-4 w-4" /></a></div>
        ...
        {menuOpen && <div className="border-t border-black/10 bg-[#fbfaf7] px-5 py-6 lg:hidden"><div className="flex flex-col gap-5 text-sm font-semibold"><a href="#funcionalidades" onClick={closeMenu}>Funcionalidades</a><a href="#para-quem" onClick={closeMenu}>Para quem</a><a href="#ecossistema" onClick={closeMenu}>Ecossistema</a><a href="#planos" onClick={closeMenu}>Planos</a><a href="#duvidas" onClick={closeMenu}>Dúvidas</a><a href="/cadastro" onClick={closeMenu} className="button button-dark mt-2 justify-center">Solicite seu acesso <ArrowRight className="h-4 w-4" /></a></div></div>}
      </header>
      ...
      <main id="inicio">
        <section ref={heroRef} className="hero-section overflow-hidden"><div className="container grid min-h-170 items-center gap-10 py-20 lg:grid-cols-[0.9fr_1.1fr] lg:py-24">
          <motion.div style={{ y: yHeroText }} className="relative z-10 max-w-147.5" initial="hidden" animate="visible" variants={staggerContainer}>
            ...
            <motion.div variants={fadeUp} className="mt-8 flex flex-wrap items-center gap-3"><a href="/cadastro" className="button button-coral">Começar agora <ArrowRight className="h-4 w-4" /></a><a href="#como-funciona" className="button button-ghost"><span className="play-ring"><Play className="h-3 w-3 fill-current" /></span> Como funciona</a></motion.div>
